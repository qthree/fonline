...
public:
    InitializeTrueChar()
    {
        ...
        const uchar name_char[] = " _.-1234567890AaBbCcDdEeFfGgHhIiJjKkLlMmNnOoPpQqRrSsTtUuVvWwXxYyZz�����������娸����������������������������������������������������";
        const uchar pass_char[] = " _-,.=[]{}?!@#$^&()|`~:;1234567890AaBbCcDdEeFfGgHhIiJjKkLlMmNnOoPpQqRrSsTtUuVvWwXxYyZz�����������娸����������������������������������������������������";
...
void GetClientOptions()
{
	...
	GameOpt.NewChatFont = cfg.GetInt(CLIENT_CONFIG_APP, "NewChatFont", false) != 0;
