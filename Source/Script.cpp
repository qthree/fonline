...
bool Script::PrepareContext( int bind_id, const char* call_func, const char* ctx_info )
{
    ...
    else
    {
        ...
        //NativeFuncDecl = bf.FuncDecl.c_str();
        ScriptCall = false;
    }
...
// Taken from AngelScript/as_callfunc_x86.cpp
...
// Taken from Source/AngelScript/as_callfunc_x64_gcc.cpp: static asQWORD __attribute__((noinline)) X64_CallFunction(const asQWORD *args, int cnt, funcptr_t func, asQWORD &retQW2, bool returnFloat) 
#if defined(FO_GCC) && defined(FO_X64)
typedef asQWORD ( *funcptr_t )( void );
static asQWORD __attribute__((noinline)) CallCDeclFunction64(const asQWORD *args, int cnt, funcptr_t func, asQWORD &retQW2, bool returnFloat) 
{
...
#endif // defined(FO_GCC) && defined(FO_X64)
...
bool Script::RunPrepared()
{
    ...
    {
        #ifdef FO_X86
        *( (uint64*) NativeRetValue ) = CallCDeclFunction32( NativeArgs, CurrentArg * sizeof(size_t), NativeFuncAddr );
        #elif defined(FO_GCC) && defined(FO_X64)
        NativeRetValue[0] = CallCDeclFunction64(NativeArgs, CurrentArg * sizeof(size_t), NativeFuncAddr, NativeRetValue[1], false);
        //WriteLog( "CallCDeclFunction64, retQW: <%d>, retQW2: <%d>\n", NativeRetValue[0], NativeRetValue[1]);
        #endif
